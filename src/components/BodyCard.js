...
export class BodyCard extends Component {
  ...
  articles= [
    ...
    },
    {
      ...
      "title": "Udaipur",
      "description": "The city of lakes and palaces, Udaipur offers a royal and romantic setting for a destination wedding must visit place.",
      "url": "/u",
    ...
    },
    {
      ...
      "title": "Kerela",
      "description": "For a serene and scenic wedding, Kerala is a great option.Kerala also offers a rich culture and cuisine that will add to the charm yours.",
      "url": "/k",
    ...
    },
    {
      ...
      "title": "Agra",
      "description": "If you want to celebrate your love in the city of love.You can have a romantic wedding in front of the Taj Mahal, the symbol of eternal love",
      "url": "/ag",
    ...
    },
    {
      ...
      "title": "Jaisalmer",
      "description": "For a desert-themed wedding. You can get married in the golden sand dunes, under the starry sky, or in the majestic forts that reflect the rich culture.",
      "url": "/ja",
